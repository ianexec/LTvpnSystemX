...
function DOMAINS_MANAGER() {
    ...
    if [ "$DOMAINS_SELECT" == "1" ]; then
        ...
        wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/domains.sh \
...
INSTALL_OHP() {
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/websocket_engine/ohp.sh && chmod +x ohp.sh && ./ohp.sh
}

INSTALL_FEATURE() {
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/HandlerSentry/install_menu.sh && chmod +x install_menu.sh && ./install_menu.sh
}

INSTALL_UDP_CUSTOM() {
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/websocket_engine/UDP.sh && chmod +x UDP.sh && ./UDP.sh
}
...
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/install_cron.sh && chmod +x install_cron.sh && ./install_cron.sh
clear
}
...
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/ssh_module/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/xray_engine/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
# limit service ip xray & quota*.py (3)
wget https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/service_limit/install.sh && chmod +x install.sh && ./install.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/ianexec/LTvpnSystemX/main/versi  )
